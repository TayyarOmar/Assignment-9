...
const authRouter = require("../HW8/routes/auth");
app.use("/auth",authRouter);


const shopRouter = require('../HW8/routes/shop');
app.use(shopRouter);

const adminRoutes=require('../HW8/routes/admin');
app.use('/admin',adminRoutes);
const errorController=require('../HW8/controllers/errors');
